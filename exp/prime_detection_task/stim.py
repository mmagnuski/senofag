...
def show_trial(df, stim, trial, effect_colors=None, resp_clock=None,
    ...
    # a delay of 60 frames (600ms)
    show_stim(window=window, stimuli=None, n_frames=60)

    # TODO change the color of the fixation point
    # show fixation and change its color
    trigger.set_sequence([0, 2], [100, 0])
    show_stim(window=window, stimuli=fix, n_frames=fix_frames, trigger=trigger)
    ...
    # show effect TODO change into flipping fix color
    # TODO change the trigger value
